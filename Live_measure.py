...
while(showLive):
    ...
    pixelsPerMetric = 0.1 # more to do here to get actual measurements that have meaning in the real world
    ...
    cv2.putText(orig, "center", (int((cX - 20)/4), int((cY - 20)/4)), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 255, 255), 2)
